...
Urban Alaska has greatly benefited from large state-subsidized energy projects, such as the Bradley Lake, Four Dam Pool, and the Alaska Intertie. Rural Alaska has not benefited from these programs. Therefore, in an effort to equalize differences between rural and urban Alaska, the Alaska Energy Authority administers the Power Cost Equalization (PCE) program. The PCE program, funded by earnings from an endowment fund, reimburses rural utilities for credits that have been provided to its customers. Eligibility is limited to residential customers and community facilities. The subsidy applies to the first 750 kWh per month of residential consumption. Community facilities are subsidized up to the first 70 kWh per month per person.  
