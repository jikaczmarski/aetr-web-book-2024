...
//dataTyped = data.map(({year}) => ({year: new Date(year,0,1)}))
...
Plot.plot({
  ...
  // Stacked area plot
  marks: [
    Plot.areaY(sw_cap, {x:"year",y:"Capacity", fill: "Prime.Mover", tip: {format: {x: "d"}}}),
    Plot.ruleY([0])
  ],
...
Plot.plot({
  ...
  // Stacked area plot
  marks: [
    Plot.barY(c_cap, {x:"year",y:"Capacity", fill: "Prime.Mover", tip: {format: {x: "d"}}}),
    Plot.ruleY([0])
  ],
  // Configure the color scheme
  color: {
...
Plot.plot({
  ...
  // Stacked area plot
  marks: [
    Plot.barY(c_r_cap, {x:"year",y:"Capacity", fill: "Prime.Mover", tip: {format: {x: "d"}}}),
    Plot.ruleY([0])
  ],
  // Configure the color scheme
  color: {
...
Plot.plot({
  ...
  // Stacked area plot
  marks: [
    Plot.barY(r_cap, {x:"year",y:"Capacity", fill: "Prime.Mover", tip: {format: {x: "d"}}}),
    Plot.ruleY([0])
  ],
  // Configure the color scheme
  color: {
...
Plot.plot({
  ...
  // Stacked area plot
  marks: [
    Plot.barY(r_r_cap, {x:"year",y:"Capacity", fill: "Prime.Mover", tip: {format: {x: "d"}}}),
    Plot.ruleY([0])
  ],
  // Configure the color scheme
  color: {
...
Plot.plot({
  ...
  // Stacked area plot
  marks: [
    Plot.barY(rr_cap, {x:"year",y:"Capacity", fill: "Prime.Mover", tip: {format: {x: "d"}}}),
    Plot.ruleY([0])
  ],
  // Configure the color scheme
  color: {
...
Plot.plot({
  ...
  // Stacked area plot
  marks: [
    Plot.barY(rr_r_cap, {x:"year",y:"Capacity", fill: "Prime.Mover", tip: {format: {x: "d"}}}),
    Plot.ruleY([0])
  ],
  // Configure the color scheme
  color: {
