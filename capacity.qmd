...
Plot.plot({
  ...
  // Configure the plot
  title: "Total Electric Generation Capacity in the Railbelt",
...
Plot.plot({
  ...
  // Configure the plot
  title: "Total Electric Generation Capacity in the Rural Remote Region",
  insetLeft: 0,
  insetRight: 0,
  color: {
    legend: true,
