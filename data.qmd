...
```{ojs}
net_generation_long_description = metadata.resources[3].description
net_generation_long = FileAttachment("data/working/generation/net_generation_long.csv").csv({typed: true});
net_generation_long_path = metadata.resources[3].path
net_generation_long_metadata = metadata.resources[3].schema.fields
